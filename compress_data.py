...
def filter_lines_with_callsign(
    ...
    with input_path.open("r", encoding="utf-8", errors="replace") as f:
        for line in f:
            ...
            if cq_pattern in line:
                ...
                # Wenn vorher eine CQ-Folge war, letzte CQ-Zeile zuerst uebernehmen
    ...
    # Falls die Datei mit einer CQ-Folge endet, die letzte CQ-Zeile noch anhaengen
    if last_was_cq and last_cq_line is not None:
        result_lines.append(last_cq_line)
...
if __name__ == "__main__":
    ...
    filter_lines_with_callsign("HB9EVT", "Excerpt_from_ALL-TXT.txt", "filtered_lines.txt")
